 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | chkwm|      | Alt  | GUI  |Lower*|    Space    |Raise*| GUI  | Alt  |      | Vim  |
 * `-----------------------------------------------------------------------------------'
 *
...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  LSFT(KC_LALT), X_____X,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC, RAISE,   KC_LGUI, KC_LALT, X_____X, VIM_START \
),
...
[_LOWER] = LAYOUT_ortho_4x12( \
  ...
  RESET, TO(_QWERTY), _______, _______, _______, KC_BSPC, KC_BSPC, _______,    _______,    _______, TO(_QWERTY), X_____X \
),
...
[_RAISE] = LAYOUT_ortho_4x12( \
  ...
  X_____X, TO(_QWERTY), _______, _______, _______, KC_BSPC, KC_BSPC, _______, _______, _______, TO(_QWERTY), RESET \
),
...
[_ADJUST] = LAYOUT_ortho_4x12( \
  ...
  RGB_TOG, TO(_MOUSE), _______, _______, _______, _______, _______, _______, _______, _______, TO(_QWERTY), X_____X \
),
