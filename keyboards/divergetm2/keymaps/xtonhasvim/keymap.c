 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | chkwm|      | Alt  | GUI  |Lower*|    Space    |Raise*| SPC  | GUI  |      | Vim  |
 * `-----------------------------------------------------------------------------------'
 *
...
[_QWERTY] = LAYOUT_ortho_4x12( \
  ...
  LSFT(KC_LALT), X_____X,  KC_LALT, KC_LGUI, LOWER,   KC_SPC,  KC_SPC, RAISE,   KC_SPC, KC_RGUI, X_____X, VIM_START \
),
...
[_ADJUST] = LAYOUT_ortho_4x12( \
  ...
  BL_TOGG, TO(_MOUSE), _______, _______, _______, _______, _______, _______, _______, _______, TO(_QWERTY), X_____X \
),
